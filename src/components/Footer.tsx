...
export default function Footer() {
  return (
    <footer className="bg-black py-12 px-6 lg:px-12 relative z-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-12">
          ...
          <div>
            <span
              className="text-[11px] font-medium tracking-[0.3em] text-white/50"
            >
              FIXMYFORM
            </span>
          </div>
          ...
          <div className="flex gap-6">
            <a
              href="#"
              className="text-white/30 hover:text-[var(--accent-warm)] transition-colors duration-300"
              aria-label="Twitter"
            >
        ...
        <div className="mt-8 flex justify-between items-center text-[9px] uppercase tracking-[0.1em] text-white/20">
          <p>© {new Date().getFullYear()} FixMyForm.</p>
